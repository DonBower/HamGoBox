...
mkdir -p /home/don/HamPi-FLDIGI && cd HamPi-FLDIGI ||
...
if ! grep -q setGPIO ~/.bashrc  ; then 
  echo "sudo sh /home/don/HamPi-FLDIGI/setGPIO" >> ~/.bashrc
fi
...
Terminal=false
Type=Application
Categories=Network;HamRadio;" > /home/don/Desktop/fldigi.desktop ||
